      ...
      <div class="col-lg-4">
        <form @submit.prevent="RegisterSubmit">
          ...
          <div class="form-group text-center">
            <button type="submit" class="btn btn-round btn-block btn-success" :disabled="errors.any() || loading"> <i  v-show="loading" class="fa fa-circle-o-notch fa-spin"></i> Register</button>
          </div>
        </form>
      </div>
    </div>
